      ...
      <Slider {...carouselSetting} className="ps-carousel">
        <div className="slide-item">
          <Link
            ...
            style={{
              backgroundImage:
                'url("https://martfuryapi.nouhtml5.com/uploads/slide_3_423f75d10d.jpg")',
        ...
        <div className="ps-section__right">
          {/* {secondBannerItems.length > 0
            ? secondBannerItems.map((item, index) => (
                <Promotion key={index} link="/shop" image={item} />
              ))
            : null} */}
          <Link href="/" className="ps-collection">
            <img
              src="https://martfuryapi.nouhtml5.com/uploads/promotion_1_d127de53e2.jpg"
              alt="martfury"
            />
          </Link>
          <Link href="/" className="ps-collection">
            <img
              src="https://martfuryapi.nouhtml5.com/uploads/promotion_2_30159b83a2.jpg"
              alt="martfury"
            />
          </Link>
        </div>

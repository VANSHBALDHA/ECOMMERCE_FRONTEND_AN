...
const Shipping = () => {
  return (
    <div className="privacy_policy_content table-responsive">
      <h2 className="text-center mb-5">Privacy Policy</h2>
      <p>
        ecommerce built the ecommerce as a Commercial app. This SERVICE is
        provided by ecommerce and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at [Your E-commerce App Name]
